...
```{r dockq-scatter-combined, fig.width=18, fig.height=10, warning=FALSE, message=FALSE, results='hide', echo=FALSE}
plots <- list()
...
```{r meandockq-bar-combined, fig.width=18, fig.height=10, warning=FALSE, message=FALSE, results='hide', echo=FALSE}
plots <- list()
...
```{r correlation-plots-combined, fig.width=18, fig.height=16, warning=FALSE, message=FALSE, results='hide', echo=FALSE}
pearson_plots <- list()
spearman_plots <- list()
